...
Yufei Wu have contribution in this project
...
The Boxplot below ( @fig-boxplotnc ) is a bloxplot of systolic blood pressure based on employment status. The plot shows that unemployed group has higher mean of systolic blood pressure compared other two groups. Part time group have the lowest blood mean levels.

```{r}
#| label: fig-boxplotnc
#| fig-cap: "Boxplot of Systolic Blood Pressure by Employment STatus"
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","boxplot_systolic_employment.png"))
```

{{< pagebreak >}}

The next figures ( @fig-scatterplot_Blood_Weight ) is a scatter plot of systolic blood pressure on body weight and color it based on employment status. There is no clear pattern of plot.

```{r}
#| label: fig-scatterplot_Blood_Weight
#| fig-cap: "Scatterplot of Weight and Systolic Blood Pressure."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","scatterplot_Blood_Weight.png"))
```

{{< pagebreak >}}

@tbl-resulttable3 shows a summary of a linear model modeling Body Weight and Employment status as predictors of Systolic Blood Pressure. From the table, Body Weight and Employment status are not statistically associated with systolic blood pressure.

```{r}
#| label: tbl-resulttable3
#| tbl-cap: "Linear model fit table modeling systolic blood pressure as a function of body weight and employment ststus."
#| echo: FALSE
