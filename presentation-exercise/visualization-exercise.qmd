...
```{r}
# Load the dataset
data_loc <- here("presentation-exercise", "data", "Philadelphia.csv") 
...
Now I have 4 subsets: summer, fall,, winter, and spring. 
Those subsets have actual_mean_temp, average_min_temp, average_max_temp, average_precipitation. 
I want to create a beautiful and easy read table. Please give me idea and step by step, including code. 
